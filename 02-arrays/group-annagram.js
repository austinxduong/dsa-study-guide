...
// O(N · M log M) - time because we are looping over the array which is proportionate to the size of the array. then inside the loop, we have to invidually sort each letter
