...
// O(n) - time because we are looping over the array which is proportionate to the size of the array
//(O(N •M) - space because first we store key/values to the size of proportionate to the array length. then inside the loop, we have to invidually sort each letter